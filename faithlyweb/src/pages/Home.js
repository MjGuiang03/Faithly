      ...
      <div className="home-layout">
        ...
        <div className="sidebar">
          ...
          <nav className="sidebar-nav">
            <button className="nav-item" onClick={() => setActiveView('dashboard')}>
              <svg className="nav-icon" fill="none" viewBox="0 0 20 20">
                <path d={svgPaths.p1fc96a00} stroke="#BEDBFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                <path d={svgPaths.p33089d00} stroke="#BEDBFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                <path d={svgPaths.p49cfa80} stroke="#BEDBFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                <path d={svgPaths.p1cfbf300} stroke="#BEDBFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              </svg>
              <span>Home</span>
            </button>
            ...
            <button className="nav-item nav-item-active" onClick={() => setActiveView('profile')}>
              <svg className="nav-icon" fill="none" viewBox="0 0 20 20">
  ...
  return (
    <div className="home-layout">
      ...
      <div className="sidebar">
        ...
        {/* Navigation */}
        <nav className="sidebar-nav">
          <button className="nav-item nav-item-active" onClick={() => setActiveView('dashboard')}>
            <svg className="nav-icon" fill="none" viewBox="0 0 20 20">
          ...
          <button className="nav-item" onClick={() => setActiveView('profile')}>
            <svg className="nav-icon" fill="none" viewBox="0 0 20 20">

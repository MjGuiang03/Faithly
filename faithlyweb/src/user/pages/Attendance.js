        ...
        <div className="user-attendance-stats">
          <div className="user-attendance-stat-card">
            <div className="user-attendance-stat-header">
              ...
              <Users className="user-attendance-stat-icon" size={20} color="#155DFC" />
              </div>
          ...
          <div className="user-attendance-stat-card">
            <div className="user-attendance-stat-header">
              ...
              <User className="user-attendance-stat-icon" size={20} color="#00A63E" />
              </div>
          ...
          <div className="user-attendance-stat-card">
            <div className="user-attendance-stat-header">
              ...
              <User className="user-attendance-stat-icon" size={20} color="#9810FA" />
              </div>

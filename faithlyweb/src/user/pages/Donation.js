          ...
          <div className="user-donations-stats">
            <div className="user-donation-stat-card">
              <div className="user-donation-stat-header">
                ...
                <Users className="user-donation-stat-icon" size={20} color="#E60076" />
              </div>
            ...
            <div className="user-donation-stat-card">
              <div className="user-donation-stat-header">
                ...
                <User className="user-donation-stat-icon" size={20} color="#00A63E" />
              </div>
            ...
            <div className="user-donation-stat-card">
              <div className="user-donation-stat-header">
                ...
                <Users className="user-donation-stat-icon" size={20} color="#155DFC" />
              </div>
              ...
              <div className="user-donation-form">
                    ...
                    <div className="user-donation-form-group" style={{ marginTop: '16px' }}>
                      ...
                      >
                        {proofFile ? (
                          ...
                          <>
                            <User className="user-proof-upload-icon" size={24} color="#99A1AF" />
                ...
                <button className="user-donate-btn" onClick={handleDonate} disabled={submitting}>
                  {submitting ? <span className="btn-spinner" /> : (
                    <>
                      <User className="user-donate-icon" size={20} color="white" />
                      Donate Now
                    </>
                  )}
                </button>
                  ...
                  {donationHistory.slice(0, 5).map((d) => (
                    ...
                    >
                      <div className="user-donation-history-main">
                        <User className="user-donation-history-icon" size={20} color="#E60076" />

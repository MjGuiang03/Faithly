...
import { Banknote, Circle, X, XCircle } from 'lucide-react';
        ...
        {[
          ...
          <div key={lt.name} className="ul-lt-card">
            <div className={`ul-lt-icon ul-lt-icon--${lt.color}`}>
              {lt.color === 'blue' && (
                <Circle size={18} color="#185fa5" />
              )}
              {lt.color === 'amber' && (
                <Circle size={18} color="#854f0b" />
              )}
              {lt.color === 'teal' && (
                <Circle size={18} color="#0f6e56" />
              )}
            </div>
